<template>
    <div>
        ...
        <div class="ypaifa" style="margin-bottom:10px;">
            ...
            <div>
                <el-button type="primary" @click="edit4" style="width:84px;">派发</el-button>
            </div>
        </div>
        ...
        <el-dialog title="设备信息" v-model="shebeiInfo">
            <!-- <el-form  ref="ruleForm" :model="formLl" >
                <template v-for="(item,key) in formL">
                    ...
                    <el-button @click="nice('ruleForm')" style="width:84px;">确认</el-button>
                    <el-button  style="width:84px;">取消</el-button>
                </el-form-item>
            </el-form> -->
             ...
             <form >
                ...
                <div style="margin-top:10px;text-align:right;">
                    ...
                    <el-button @click="nicetwo()"  type="primary">提交</el-button>
                </div>
            </form>
        </el-dialog>
    </div>
