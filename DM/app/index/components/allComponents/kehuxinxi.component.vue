<template>
    <div style="height:100%;overflow:auto; background:#f2f2f2;padding:10px 20px 0 20px;" >
            <el-col :span="24" class="toolbar">
                <el-form :inline="true" >
                        <el-input icon="search" style="width:50%;"  v-model="text"   placeholder="请输入客户信息" type="text" class="tablesearch_box" :maxlength="30"></el-input>
                    <el-form-item>
                        <el-button type="primary" class="w-search-button" style="width:84px;"  @click="searchList">搜索</el-button>
                    </el-form-item>
                </el-form>
            </el-col>
            <!--渲染表格数据-->
            <el-table  :data="customersList" border  style="width: 100%;" class="w-nopadding" row-key="sid" @selection-change="handleSelectionChange">
                ...
                <el-table-column  label="订单"  width="50">
                ...
                <el-table-column   label="操作" width="180"  align='left'>
                    <template scope="scope">
                        <el-button class="w-button" size="small" @click="handleEdit(scope.$index, scope.row)"><img src="../../imgs/edit1.png" title="修改"></el-button>
                        <el-button class="w-button" size="small" @click="handleDel(scope.$index, scope.row)"><img src="../../imgs/del.png" title="删除"></el-button>
                        <el-button class="w-button" size="small" @click="handleReset(scope.$index, scope.row)"><img src="../../imgs/reset.png" title="重置密码"></el-button>
                        <el-button class="w-button" size="small" @click="handleForbidden(scope.$index, scope.row)"><img src="../../imgs/forbidden.png" title="禁用"></el-button>
                    </template>
                </el-table-column>
            </el-table>
            <!--分页-->
        ...
        methods:{
            ...
            handleCustomer:function(){
                ...
                this.$http.post(api.customerList,para).then((res) =>{
                    ...
                    // this.customersList[1].check = true;
                })
            },
            //编辑弹框显示
