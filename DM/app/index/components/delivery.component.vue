<template>
    <div>
        ...
        <div class="ypaifa" style="margin-bottom:10px;">
            ...
            <div>
                <el-button type="primary" @click="edit2" style="width:84px;">派发</el-button>
            </div>
        </div>
          ...
          <div style="border:1px solid #d1d1d1;">
              <div class="yChanpin" v-for="(item,key) in keeper.orderItemList">
                  ...
                  <div style="border-bottom:1px solid #d1d1d1;" class="ybj">
                        <div class="yshebeiSN"><span v-for="(equipmentId,key) in item.equipmentInfoList">{{equipmentId.equipmentId}}/</span></div>
                        <div>
            ...
            <form >
               <template v-for="(item,key) in formL">
                  ...
                  <div style="margin-top:10px;text-align:right;">
                      ...
                      <el-button @click="niceone()"  type="primary">提交</el-button>
                  </div>
           </form>
        </el-dialog>
    </div>
            ...
            edit2 () {
                this.$confirm("确认派发信息？",{
                    ...
                    if(this.value1.length==0){
                        ...
                        for(var i=0;i<$(".yshebeiSN").length;i++){
                            if($(".yshebeiSN").eq(i).text()==""){
                                this.$alert("SN号不能为空");
                                 return;
                            }
                        }
