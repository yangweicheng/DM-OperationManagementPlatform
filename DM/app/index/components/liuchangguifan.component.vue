<template>
    <div style="padding:10px 20px 0 20px;height:100%;overflow-y:auto;">
        <div style="margin-bottom:10px;" class="yGFm">
            <el-input icon="search" placeholder="规范名称/规范类型" style="width:50%;" v-model="input"></el-input>
            <el-button type="primary" @click="sousou" style="width:84px;">搜索</el-button>
            <el-button type="primary" @click="uplods" style="width:84px;">上传</el-button>
        </div>
       ...
       <el-dialog title="上传" v-model="dialogs">
           <el-form :model="values" :rules="rules" ref="roleForm">
               ...
               <el-form-item style="text-align:center;">
                   <el-button @click="guifanuploads('roleForm')" style="width:84px;" type="primary">上传</el-button>
               </el-form-item>
           </el-form>
       </el-dialog>
       <!-- 修改 -->
  ...
  :headers="head"  :data="editV" accept="application/msword,application/pdf">
               ...
               <el-form-item style="text-align:center;">
                   <el-button @click="guifanedit('roleForm')" style="width:84px;" type="primary">提交</el-button>
               </el-form-item>
           </el-form>
       </el-dialog>
    </div>
        ...
        methods:{
            ...
            guifanuploads (roleForm) {
                this.$confirm("确认上传？",{
                    ...
                    if(this.values.standardType=="请选择"){
            ...
            uplods () {
                this.values.standardType='请选择';
                this.productFilesName="只能选取.pdf,.docx,.doc格式的文件";
                this.dialogs=!this.dialogs
            },
