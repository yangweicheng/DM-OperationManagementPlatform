<template>
    <div style="padding:10px 20px 0 20px;">
        ...
        <!-- 表格 -->
        <el-table :data="cuestableData" style="width:100%;" stripe border v-loading.body="loading">
        ...
        <el-dialog title="权限设置" v-model="setQx">
            <el-tree :data="setQxData" :props="defaultProps" node-key="sid" show-checkbox :default-checked-keys="selected" ref="tree" accordion v-loading.body="loadingQ" style="margin-bottom:10px;"></el-tree>
            <div style="text-align:right">
                <el-button @click="setQx=!setQx" >取消</el-button>
                <el-button @click="getCheckedKeys"  type="primary">确认</el-button>
            </div>
        </el-dialog>
    </div>
</template>
