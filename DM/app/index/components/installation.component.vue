<template>
    <div>
        ...
        <div class="ypaifa" style="margin-bottom:10px;">
            ...
            <div>
                <el-button type="primary" @click="edit2" :disabled="dis" style="width:84px;">派发</el-button>
            </div>
        </div>
        ...
        methods:{
            ...
            edit2 () {
                this.$confirm("确认派发信息？",{
                    ...
                    let params={
                        sid:this.keeper.sid,
                        customerId:this.keeper.customerId,
                        orderNumber:this.keeper.orderNumber
                    }
                    this.$http.post(api.sendMessage,params).then((response)=>{
                        // console.log(response.body)
