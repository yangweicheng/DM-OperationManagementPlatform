    ...
    <div>
        ...
        <div class="ydingdanmain">
          ...
          <div  style="border-bottom:1px solid #d1d1d1;margin-bottom:10px;" class="yAddressee">
              <div>
                  <b>施工人员：</b>
                  <el-select v-model="value1" placeholder="请选择" clearable multiple :disabled="shigongxinxi">
          ...
          <div style="border:1px solid #d1d1d1;">
              <div class="yChanpin" v-for="(item,key) in keeper.orderItemList">
                  ...
                  <div style="border-bottom:1px solid #d1d1d1;" class="ybj">
                        <div class="yshebeiSNeditThree"><span v-for="(equipmentId,key) in item.equipmentInfoList" >{{equipmentId.equipmentId}}/</span></div>
                        <div>
            ...
            <form >
               <template v-for="(item,key) in formL">
                  ...
                  <div style="margin-top:10px;text-align:right;">
                      ...
                      <el-button @click="niceEditThree()"  type="primary">提交</el-button>
                  </div>
           </form>
        </el-dialog>
    </div>
            ...
            edit () {
                this.$confirm("确认修改信息？",{
                    ...
                    if(this.$route.params.button==3){
                        for(var i=0;i<$(".yshebeiSNeditThree").length;i++){
                            if($(".yshebeiSNeditThree").eq(i).text()==""){
                                this.$alert("SN号不能为空");
                                 return;
                            }
                        }
                        var aa=[]
                        for(var i=0;i<$(".yshebeiSNeditThree").length;i++){
                            aa.push($(".yshebeiSNeditThree").eq(i).text())
                        }
